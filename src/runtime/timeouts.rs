...
impl ResolvedTimeoutPolicy {
    pub fn resolve(global: &TimeoutPolicy, rule: Option<&RuleTimeoutPolicy>) -> Self {
        Self {
...
fn resolve_seconds(rule: Option<u64>, global: u64) -> u64 {
    rule.unwrap_or(global)
}

fn resolve_u64(rule: Option<u64>, global: u64) -> u64 {
    rule.unwrap_or(global)
}
...
mod tests {
    ...
    fn rule_timeout_overrides_global_timeout() {
        ...
        let resolved = ResolvedTimeoutPolicy::resolve(&global, Some(&rule));
